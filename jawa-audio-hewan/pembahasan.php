  ...
  <div class="container">
    <div class="col-lg-11 my-5 mx-auto">
        ...
        <?php
          ...
          for ($i=1; $i <= 3; $i++) {
            $query = mysqli_query($db, "SELECT * FROM soal_jawa_audio_hewan WHERE id_soal = $i");
            while ($rows = mysqli_fetch_array($query)) {
        ?>
              ...
              <div class="card mb-4 pertanyaan" id="container">
                <audio controls class="align-self-center" style="width: 500px; margin-top: 125px; margin-bottom: 50px;">
                  <source src="../audio/<?php echo $rows['audio_soal']; ?>" type="audio/mpeg">
                </audio>
                ...
                <div class="mb-3 col-11 mx-auto d-flex justify-content-center align-items-center">
                  ...
                  ?>
                      <section class="pilihan ms-3 me-4 d-flex justify-content-center <?php if(isset($selected[$i])){
